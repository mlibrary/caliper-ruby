...
describe Caliper::Events::AnnotationEvent do
  subject do
    described_class.new(
      actor: actor,
      action: Caliper::Actions::HIGHLIGHTED,
      edApp: ed_app,
  ...
  let(:highlight) do
    Caliper::Entities::Annotation::HighlightAnnotation.new(
  ...
  include_examples 'validation against common fixture', 'caliperEventAnnotationHighlighted.json'
end
