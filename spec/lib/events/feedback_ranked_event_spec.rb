...
describe Caliper::Events::FeedbackEvent do
  ...
  let(:generated) do
    Caliper::Entities::Feedback::Rating.new(
  ...
  include_examples 'validation against common fixture', 'caliperEventFeedbackRanked.json', excluding: [:isPartOf, :commentedOn, :commenter, :rater, :rated]
end
