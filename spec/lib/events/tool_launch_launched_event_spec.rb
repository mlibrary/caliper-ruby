...
describe Caliper::Events::ToolLaunchEvent do
  subject do
    described_class.new(
      action: Caliper::Actions::LAUNCHED,
      actor: actor,
      edApp: ed_app,
  ...
  include_examples 'validation against common fixture', 'caliperEventToolLaunchLaunched.json', optimize: {except: [:edApp, :user, :object]}
end
